...
const sprites = "/assets/icons-CBvi2zyi.svg";
...
const heading$1 = "_heading_e2qtd_2";
const styles$s = {
  heading: heading$1
};
const Heading = ({
...
const monogram = "_monogram_13y1b_2";
const highlight = "_highlight_13y1b_15";
const styles$p = {
  monogram,
  highlight
};
const logo$1 = "/assets/logo-C6qzRp2H.svg";
const Monogram = forwardRef(({ highlight: highlight2, className, ...props }, ref) => {
  return /* @__PURE__ */ jsxs("div", { className: classes(styles$p.monogram, className), ref, ...props, children: [
    /* @__PURE__ */ jsx("img", { src: logo$1, alt: "Logo", width: "60", height: "60" }),
    highlight2 && /* @__PURE__ */ jsx("div", { className: styles$p.highlight })
  ] });
});
...
const name$2 = "Oluwadamilare Moshood";
const role = "Fullstack Web";
const disciplines = [
  "Developer",
  "IT Manager",
  "Game Developer",
...
const url$1 = "https://damilareymo.com";
const twitter$1 = "@crypticlarkson";
const linkedin = "@Oluwadamilaremo";
const Instagram = "@Oluwadamilareclarkson";
const github = "damilarey-MO";
const repo = "https://github.com/damilarey-MO";
...
const Footer = ({ className }) => /* @__PURE__ */ jsx("footer", { className: classes(styles$i.footer, className), children: /* @__PURE__ */ jsxs(Text, { size: "s", align: "center", children: [
  ...
  /* @__PURE__ */ jsx(Link, { secondary: true, className: styles$i.link, href: "/humans.txt", target: "_self", children: "BUILT BY YOURS TRULY" })
] }) });
  ...
  return /* @__PURE__ */ jsx(Section, { className: classes(styles$g.header, className), as: "section", children: /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        !!(roles2 == null ? void 0 : roles2.length) && /* @__PURE__ */ jsx("ul", { className: styles$g.meta, children: roles2 == null ? void 0 : roles2.map((role2, index2) => /* @__PURE__ */ jsx(
          "li",
          {
...
const Carousel = lazy(
  () => import("./index-B46JaWEa.js").then((module2) => ({ default: module2.Carousel }))
);
const Armor = lazy(() => import("./armor-CPIIbpH7.js").then((module2) => ({ default: module2.Armor })));
...
const Earth = lazy(() => import("./earth-DeJvhL2e.js").then((module2) => ({ default: module2.Earth })));
const EarthSection = lazy(
  () => import("./earth-DeJvhL2e.js").then((module2) => ({ default: module2.EarthSection }))
);
...
async function getPosts() {
  ...
  const posts = await Promise.all(
    Object.entries(modules).map(async ([file, post2]) => {
      ...
      const text2 = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({}), `../articles.${slug}.mdx`, 2);
...
const header = "_header_nr520_53";
const heading = "_heading_nr520_71";
const list$1 = "_list_nr520_76";
const divider$1 = "_divider_nr520_80";
const skeleton = "_skeleton_nr520_85";
const skeletonBone = "_skeletonBone_nr520_94";
const post = "_post_nr520_98";
...
const timecode = "_timecode_nr520_370";
...
function ArticlesPost({ slug, frontmatter, timecode: timecode2, index: index2 }) {
  const [hovered, setHovered] = useState(false);
  const [dateTime, setDateTime] = useState(null);
  const reduceMotion = useReducedMotion();
  const { title: title2, abstract, date: date2, featured, banner } = frontmatter;
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsxs(
    "article",
    {
      ...
      children: [
        featured && /* @__PURE__ */ jsx(Text, { className: styles$b.postLabel, size: "s", children: "Featured" }),
        featured && !!banner && /* @__PURE__ */ jsx("div", { className: styles$b.postImage, children: /* @__PURE__ */ jsx(
          Image$1,
          {
            noPauseButton: true,
        ...
        featured && /* @__PURE__ */ jsx(Text, { "aria-hidden": true, className: styles$b.postTag, size: "s", children: "477" })
      ]
    }
  );
}
...
const sliceTextureLarge = "/assets/slice-app-large-BwXr7g00.jpg";
...
const sliceTexture = "/assets/slice-app-Se1vQA3s.jpg";
...
const Slice = () => {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(ProjectContainer, { className: styles$a.slice, children: [
      /* @__PURE__ */ jsx(
        ProjectBackground,
        {
          src: sliceBackground,
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { centered: true, className: styles$a.columns, children: [
        /* @__PURE__ */ jsxs("div", { className: styles$a.imagesText, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$a.sidebarImages, children: [
          /* @__PURE__ */ jsx(
            Image$1,
            {
              className: styles$a.sidebarImage,
      ...
      /* @__PURE__ */ jsx(ProjectSection, { padding: "top", children: /* @__PURE__ */ jsxs(ProjectSectionContent, { className: styles$a.grid, children: [
        /* @__PURE__ */ jsxs("div", { className: styles$a.gridImage, children: [
          /* @__PURE__ */ jsx("div", { className: styles$a.gridBackground, children: /* @__PURE__ */ jsx(
            Image$1,
            {
          ...
          /* @__PURE__ */ jsx("div", { className: styles$a.gridForeground, children: /* @__PURE__ */ jsx(
            Image$1,
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$a.gridText, children: [
...
const gamestackTexture2Large = "/assets/gamestack-list-large-tLiqcKzd.jpg";
...
const gamestackTextureLarge = "/assets/gamestack-login-large-CsLCH5ui.jpg";
...
const DisplacementSphere = lazy(
  () => import("./displacement-sphere-BWVb7syW.js").then((module2) => ({ default: module2.DisplacementSphere }))
);
...
const profileImgLarge = "/assets/profile-CUh-Rp2D.jpg";
const profileImgPlaceholder = "/assets/profile-placeholder-DOgU6wR2.jpg";
const profileImg = "/assets/profile-CUh-Rp2D.jpg";
...
const ProfileText = ({ visible, titleId }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  /* @__PURE__ */ jsxs(Text, { className: styles$4.description, "data-visible": visible, size: "l", as: "p", children: [
    "I’m Oluwadamilare Moshood(Darey), an experienced IT Manager and Full Stack Developer based in Lagos, Nigeria. I currently manage IT operations at ",
    /* @__PURE__ */ jsx(Link, { href: "https://www.crownedgear.com", children: "Crownedgear Luxury" }),
    ", where I lead e-commerce platform upgrades, implement advanced data analytics tools, and strengthen cybersecurity measures. My skillset spans web development (React, JavaScript), IT management, and technical support."
  ] }),
  /* @__PURE__ */ jsxs(Text, { className: styles$4.description, "data-visible": visible, size: "l", as: "p", children: [
    "Outside of work, I’m passionate about Afrobeat music, and I’m working on a Tech solution Platform for Tech Users and Organizations. I also enjoy exploring new tech projects, so feel free to ",
    /* @__PURE__ */ jsx(Link, { href: "/contact", children: "reach out" }),
    " if you would like to collaborate or discuss a project."
  ] })
] });
...
const Model = lazy(
  () => import("./index-DzsG9TsN.js").then((module2) => ({ default: module2.Model }))
);
...
const meta$2 = () => {
  return baseMeta({
    title: "Fullstack Web",
    description: `Portfolio website of ${config.name} — Web and IT Manager working on web & mobile apps with a focus on scalabilty, responsiveness, and accessibility.`
  });
};
const Home = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$2.home, children: [
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        description: "Responsive MERN stack React projects",
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        index: 2,
        title: "Web Based Game Projects",
        description: "Interactive Web based games",
        buttonText: "View website",
        buttonLink: "https://games.damilareymo.com",
        model: {
          type: "phone",
          alt: "JavaScriptGames",
          textures: [
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        description: "Tech solutions showcasing my Fullstack Dev. skills",
        buttonText: "View project",
        buttonLink: "/projects/slice",
        model: {
          type: "laptop",
          alt: "FullstackWebSolutions",
          textures: [
            {
              srcSet: `${sliceTexture} 800w, ${sliceTextureLarge} 1920w`,
              placeholder: sliceTexturePlaceholder
      ...
      /* @__PURE__ */ jsx(ProjectSection, { padding: "none", className: styles.section, children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsxs(ProjectTextRow, { width: "m", children: [
        ...
        /* @__PURE__ */ jsx(ProjectSectionText, { as: "div", children: /* @__PURE__ */ jsxs(List, { children: [
          /* @__PURE__ */ jsxs(ListItem, { children: [
            ...
            " ",
            /* @__PURE__ */ jsx(Link, { href: "https://www.figma.com/@damilareymo", children: "a few plugins" }),
      ...
      /* @__PURE__ */ jsx(ProjectSection, { padding: "none", className: styles.section, children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsxs(ProjectTextRow, { width: "m", children: [
        ...
        /* @__PURE__ */ jsx(ProjectSectionText, { as: "div", children: /* @__PURE__ */ jsxs(List, { children: [
          ...
          /* @__PURE__ */ jsxs(ListItem, { children: [
            ...
            ". Check out the",
            " ",
            /* @__PURE__ */ jsx(Link, { href: "https://storybook.damilareymo.com", children: "storybook for this website" }),
            "."
          ] })
        ] }) })
      ] }) }) }),
...
const serverManifest = { "entry": { "module": "/assets/entry.client-9KIVAs2V.js", "imports": ["/assets/components-BEVlEQcB.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-CqwGyqWC.js", "imports": ["/assets/components-BEVlEQcB.js", "/assets/image-DB6rRj2u.js", "/assets/error-CpexqlFM.js", "/assets/visually-hidden-2pJgnlak.js", "/assets/heading-CcgLg--t.js", "/assets/useScrollToHash-Cs8XN3oY.js", "/assets/useWindowSize-CZUHPkza.js", "/assets/config-DohaZlFR.js", "/assets/decoder-text-CEhAazX1.js", "/assets/use-spring-jzPCatCZ.js", "/assets/index-D5Qb4_P8.js"], "css": ["/assets/root-CnFX9aeL.css", "/assets/image-CQFqa4Pm.css", "/assets/heading-DxmoR0-i.css", "/assets/error-CmEnn51Q.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/visually-hidden-DZKbrLgw.css"] }, "routes/projects.volkihar-knight": { "id": "routes/projects.volkihar-knight", "parentId": "root", "path": "projects/volkihar-knight", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-uPSafUQe.js", "imports": ["/assets/preload-helper-D7HrI6pR.js", "/assets/components-BEVlEQcB.js", "/assets/heading-CcgLg--t.js", "/assets/section-CImFuiBC.js", "/assets/image-DB6rRj2u.js", "/assets/project-gv7L_m-t.js", "/assets/meta-JHHU1yu-.js", "/assets/config-DohaZlFR.js"], "css": ["/assets/route-BT5UbU5w.css", "/assets/heading-DxmoR0-i.css", "/assets/section-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css"] }, "routes/projects.smart-sparrow": { "id": "routes/projects.smart-sparrow", "parentId": "root", "path": "projects/smart-sparrow", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-Cbwi4QAs.js", "imports": ["/assets/preload-helper-D7HrI6pR.js", "/assets/components-BEVlEQcB.js", "/assets/spr-lesson-builder-dark-2npVmSdB.js", "/assets/section-CImFuiBC.js", "/assets/image-DB6rRj2u.js", "/assets/visually-hidden-2pJgnlak.js", "/assets/heading-CcgLg--t.js", "/assets/project-gv7L_m-t.js", "/assets/meta-JHHU1yu-.js", "/assets/config-DohaZlFR.js"], "css": ["/assets/route-PiXNUkZG.css", "/assets/section-CUrllC_C.css", "/assets/heading-DxmoR0-i.css", "/assets/image-CQFqa4Pm.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/project-D3JpM_tk.css"] }, "routes/articles_._index": { "id": "routes/articles_._index", "parentId": "root", "path": "articles", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-179TwMha.js", "imports": ["/assets/meta-JHHU1yu-.js", "/assets/components-BEVlEQcB.js", "/assets/heading-CcgLg--t.js", "/assets/decoder-text-CEhAazX1.js", "/assets/divider-BNZHkPqF.js", "/assets/section-CImFuiBC.js", "/assets/image-DB6rRj2u.js", "/assets/useWindowSize-CZUHPkza.js", "/assets/config-DohaZlFR.js", "/assets/visually-hidden-2pJgnlak.js", "/assets/use-spring-jzPCatCZ.js", "/assets/index-D5Qb4_P8.js"], "css": ["/assets/route-DtSYASGB.css", "/assets/heading-DxmoR0-i.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/divider-CJ0zz9kw.css", "/assets/section-CUrllC_C.css", "/assets/image-CQFqa4Pm.css"] }, "routes/projects.slice": { "id": "routes/projects.slice", "parentId": "root", "path": "projects/slice", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BWs8478J.js", "imports": ["/assets/components-BEVlEQcB.js", "/assets/slice-app-BIKJtoDB.js", "/assets/section-CImFuiBC.js", "/assets/image-DB6rRj2u.js", "/assets/project-gv7L_m-t.js", "/assets/heading-CcgLg--t.js", "/assets/meta-JHHU1yu-.js", "/assets/config-DohaZlFR.js"], "css": ["/assets/route-BMFIlMHl.css", "/assets/section-CUrllC_C.css", "/assets/heading-DxmoR0-i.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css"] }, "routes/api.set-theme": { "id": "routes/api.set-theme", "parentId": "root", "path": "api/set-theme", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api.set-theme-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/articles": { "id": "routes/articles", "parentId": "root", "path": "articles", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BBzWhhE9.js", "imports": ["/assets/meta-JHHU1yu-.js", "/assets/config-DohaZlFR.js"], "css": [] }, "routes/contact": { "id": "routes/contact", "parentId": "root", "path": "contact", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DeFtKFbv.js", "imports": ["/assets/components-BEVlEQcB.js", "/assets/heading-CcgLg--t.js", "/assets/decoder-text-CEhAazX1.js", "/assets/divider-BNZHkPqF.js", "/assets/section-CImFuiBC.js", "/assets/meta-JHHU1yu-.js", "/assets/visually-hidden-2pJgnlak.js", "/assets/use-spring-jzPCatCZ.js", "/assets/index-D5Qb4_P8.js", "/assets/config-DohaZlFR.js"], "css": ["/assets/route-DZ4V55Yk.css", "/assets/heading-DxmoR0-i.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/divider-CJ0zz9kw.css", "/assets/section-CUrllC_C.css"] }, "routes/home": { "id": "routes/home", "parentId": "root", "path": "home", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DnvvihW-.js", "imports": ["/assets/route-DaU6nUav.js", "/assets/components-BEVlEQcB.js", "/assets/slice-app-BIKJtoDB.js", "/assets/spr-lesson-builder-dark-2npVmSdB.js", "/assets/section-CImFuiBC.js", "/assets/heading-CcgLg--t.js", "/assets/config-DohaZlFR.js", "/assets/meta-JHHU1yu-.js", "/assets/preload-helper-D7HrI6pR.js", "/assets/decoder-text-CEhAazX1.js", "/assets/visually-hidden-2pJgnlak.js", "/assets/use-spring-jzPCatCZ.js", "/assets/index-D5Qb4_P8.js", "/assets/image-DB6rRj2u.js", "/assets/useScrollToHash-Cs8XN3oY.js", "/assets/divider-BNZHkPqF.js", "/assets/useWindowSize-CZUHPkza.js"], "css": ["/assets/route-B0j0lWmR.css", "/assets/section-CUrllC_C.css", "/assets/heading-DxmoR0-i.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/image-CQFqa4Pm.css", "/assets/divider-CJ0zz9kw.css"] }, "routes/uses": { "id": "routes/uses", "parentId": "root", "path": "uses", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-D05GDapN.js", "imports": ["/assets/components-BEVlEQcB.js", "/assets/section-CImFuiBC.js", "/assets/heading-CcgLg--t.js", "/assets/project-gv7L_m-t.js", "/assets/meta-JHHU1yu-.js", "/assets/config-DohaZlFR.js", "/assets/image-DB6rRj2u.js"], "css": ["/assets/route-DLxMrFZt.css", "/assets/section-CUrllC_C.css", "/assets/heading-DxmoR0-i.css", "/assets/project-D3JpM_tk.css", "/assets/image-CQFqa4Pm.css"] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/_-BTLfj739.js", "imports": ["/assets/components-BEVlEQcB.js", "/assets/error-CpexqlFM.js", "/assets/heading-CcgLg--t.js", "/assets/decoder-text-CEhAazX1.js", "/assets/visually-hidden-2pJgnlak.js", "/assets/use-spring-jzPCatCZ.js", "/assets/index-D5Qb4_P8.js", "/assets/image-DB6rRj2u.js"], "css": ["/assets/error-CmEnn51Q.css", "/assets/heading-DxmoR0-i.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/image-CQFqa4Pm.css"] }, "routes/home/route": { "id": "routes/home/route", "parentId": "root", "path": "/", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DnvvihW-.js", "imports": ["/assets/route-DaU6nUav.js", "/assets/components-BEVlEQcB.js", "/assets/slice-app-BIKJtoDB.js", "/assets/spr-lesson-builder-dark-2npVmSdB.js", "/assets/section-CImFuiBC.js", "/assets/heading-CcgLg--t.js", "/assets/config-DohaZlFR.js", "/assets/meta-JHHU1yu-.js", "/assets/preload-helper-D7HrI6pR.js", "/assets/decoder-text-CEhAazX1.js", "/assets/visually-hidden-2pJgnlak.js", "/assets/use-spring-jzPCatCZ.js", "/assets/index-D5Qb4_P8.js", "/assets/image-DB6rRj2u.js", "/assets/useScrollToHash-Cs8XN3oY.js", "/assets/divider-BNZHkPqF.js", "/assets/useWindowSize-CZUHPkza.js"], "css": ["/assets/route-B0j0lWmR.css", "/assets/section-CUrllC_C.css", "/assets/heading-DxmoR0-i.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/image-CQFqa4Pm.css", "/assets/divider-CJ0zz9kw.css"] } }, "url": "/assets/manifest-8ea52df8.js", "version": "8ea52df8" };
