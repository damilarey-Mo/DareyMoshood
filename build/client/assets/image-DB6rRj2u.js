import{r,j as f}from"./components-BEVlEQcB.js";import{c as R,g as N,t as L,h as C,a as P,n as E,u as q,B as Q,I as J}from"./heading-CcgLg--t.js";const X="/assets/gotham-bold-italic-C_msAlmW.woff2",Y="/assets/gotham-bold-D1kvQ7KV.woff2",Z="/assets/gotham-book-italic-Bm2IEtSK.woff2",ee="/assets/gotham-book-Bnaws0Ef.woff2",te="/assets/gotham-medium-italic-Dok430ou.woff2",oe="/assets/gotham-medium-0VT3RO8I.woff2",se="/assets/ipa-gothic-DimHCOud.woff2",z=r.createContext({}),Ie=({theme:e="dark",children:t,className:n,as:s="div",toggleTheme:i,...a})=>{const o=W(),c=!o.theme;return f.jsxs(z.Provider,{value:{theme:e,toggleTheme:i||o.toggleTheme},children:[c&&t,!c&&f.jsx(s,{className:R(n),"data-theme":e,...a,children:t})]})};function W(){return r.useContext(z)}function g(e){return e.replace(/\s\s+/g," ")}function j(e){return g(Object.keys(e).map(t=>`--${t}: ${e[t]};`).join(`
